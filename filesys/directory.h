...
class DirectoryEntry {
  public:
    ...
    char name[FileNameMaxLen + 1];	// Text name for file, with +1 for 
					// the trailing '\0'
//****EDIT****
	char ExtName[FileExtNameMaxLen + 1];
...
class Directory {
  public:
    ...
    void FetchFrom(OpenFile *file, bool seekZero = true);  	// Init directory contents from disk
    void WriteBack(OpenFile *file, bool seekZero = true);	// Write modifications to 
